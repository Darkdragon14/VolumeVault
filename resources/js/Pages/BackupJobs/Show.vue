        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <section class="card p-4 sm:p-5 lg:col-span-2">
                ...
                <dl class="grid gap-4 sm:grid-cols-2">
                    ...
                    <div v-if="job.backup_filter_mode === 'include'"><dt class="text-xs uppercase text-slate-400">{{ t('Included folders') }}</dt><dd class="mt-1 break-all font-mono text-sm text-white">{{ job.backup_include_paths || t('Everything') }}</dd></div>
