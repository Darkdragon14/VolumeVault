...
return [
    'multi_host_agents' => [
        'title' => 'Agenti Docker multi-host',
        'description' => 'VolumeVault puo ora rilevare i volumi Docker tramite agenti remoti registrati, mantenendo isolate le operazioni locali di backup e ripristino. Registrazione, lease dei comandi, heartbeat e inventari sono protetti da replay, sovrapposizioni e richieste eccessive.',
    ],
