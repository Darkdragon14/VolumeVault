...
class AgentCompatibility
{
    ...
    public const CAPABILITIES = ['inventory-v1', 'maintenance-v1', 'backup-v1', 'restore-v1', 'docker-labels-v1', 'destination-v1', 'archive-relay-v1', 'sftp-host-key-v1', 'archive-metadata-v1'];
