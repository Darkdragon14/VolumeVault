        ...
        return [
            ...
            'BackupJobRequest' => [
                ...
                'properties' => [
                    ...
                    'backup_include_paths' => ['type' => ['string', 'null'], 'maxLength' => 2000, 'description' => 'Comma-separated list of folders/files to keep, relative to the volume root (e.g. "Backups, config/app.conf"). Used only when backup_filter_mode is "include". Empty keeps everything.'],
