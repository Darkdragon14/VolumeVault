        ...
        return [
            ...
            'RestoreRequest' => [
                ...
                'properties' => [
                    ...
                    'target_docker_host_id' => ['type' => 'integer', 'description' => 'Execution target host; defaults to the job host. Cross-host restores require new_volume mode and a shared network destination. Remote targets require restore-v1.'],
