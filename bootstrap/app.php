...
use App\Http\Middleware\RequireAgentTransport;
...
return Application::configure(basePath: dirname(__DIR__))
    ->withRouting(
        ...
        health: '/up',
        then: function (): void {
            Route::prefix('agent/v1')->middleware(RequireAgentTransport::class)->group(base_path('routes/agent.php'));
        },
    )
    ->withCommands([
    ...
    ->withExceptions(function (Exceptions $exceptions) {
        $exceptions->dontFlash(['credential', 'enrollment_token']);
    })->create();
